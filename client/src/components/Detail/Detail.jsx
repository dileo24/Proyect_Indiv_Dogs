            ...
            {dogDetail.length > 0
                ? <div className={style.detailText}>
                    ...
                    <div className={style.info}>
                        <h4>Altura Promedio:<br />{dogDetail[0].height}</h4>
                        <h4>Peso Promedio:<br /> {dogDetail[0].weight}</h4>
                        <h4>Años de vida:<br />{dogDetail[0].life_span}</h4>
                    </div>
                    <h3>Temperamentos: {dogDetail[0].temperament}</h3>
                    <img src={dogDetail[0].image} alt='img' className={style.detailPhoto}></img>
                </div>
